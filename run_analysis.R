# Reading Data
x_test <- read.table("F://JHU/Cleaning/UCI HAR Dataset/test/X_test.txt")
y_test <- read.table("F://JHU/Cleaning/UCI HAR Dataset/test/y_test.txt")
x_train <- read.table("F://JHU/Cleaning/UCI HAR Dataset/train/X_train.txt")
y_train <- read.table("F://JHU/Cleaning/UCI HAR Dataset/train/y_train.txt")
act_labs <- read.table("F://JHU/Cleaning/UCI HAR Dataset/activity_labels.txt")
feats <- read.table("F://JHU/Cleaning/UCI HAR Dataset/features.txt")
subject_test <- read.table("F://JHU/Cleaning/UCI HAR Dataset/test/subject_test.txt")
subject_train <- read.table("F://JHU/Cleaning/UCI HAR Dataset/train/subject_train.txt")
